        ...
        <div class="modal-body">
            <form id="addCategoryForm">
                ...
                <div class="form-group">
                    ...
                    <textarea id="form-description" type="text" rows="3" class="form-control" name="description" placeholder="enter text description"></textarea>
                </div>
            </form>
        </div>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addCategoryForm">
                    ...
                    <div class="form-group">
                        <label> Description </label>
                        <textarea id="form-description-edit" type="text" rows="3" class="form-control" name="description" placeholder="enter text description"></textarea>
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
<script type="text/javascript" src="{{URL::asset('js/categoriesAdmin.js')}}"></script>
