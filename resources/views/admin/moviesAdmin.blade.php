...
@section('content')
<h1 class="title">Movies Admin</h1>
<div class="container">
        ...
        <div class="modal-body">
            <form id="addMovieForm">
                ...
                <div class="form-group">
                    ...
                    <textarea id="form-description" type="text" rows="5" class="form-control" name="description" placeholder="enter text description"></textarea>
                </div>
                <div class="form-group">
                    <label> Price </label>
                    <input id="form-price" type="number" class="form-control" name="price" placeholder="enter price">
                </div>
                <div class="form-group">
                    <label> Image link </label>
                    <input id="form-image" type="text" class="form-control" name="image" placeholder="enter image">
                </div>
                <div class="form-group">
                    <label> Trailer link </label>
                    <input id="form-trailer" type="text" class="form-control" name="trailer" placeholder="enter trailer">
                </div>
                <div class="form-group">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addUserForm">
                    ...
                    <div class="form-group">
                        <label> Description </label>
                        <textarea id="form-description-edit" type="text" rows="5" class="form-control" name="description" placeholder="enter text description"></textarea>
                    </div>
                    <div class="form-group">
                        <label> Price </label>
                        <input id="form-price-edit" type="number" class="form-control" name="price" placeholder="enter price">
                    </div>
                    <div class="form-group">
                        <label> Image link </label>
                        <input id="form-image-edit" type="text" class="form-control" name="image" placeholder="enter image">
                    </div>
                    <div class="form-group">
                        <label> Trailer link </label>
                        <input id="form-trailer-edit" type="text" class="form-control" name="trailer" placeholder="enter trailer">
                    </div>
                    <div class="form-group">
                        <label> Select Category </label>
                        <select name="category" id="form-category-edit" class="form-control">
                        </select>
                    </div>
                </form>
            </div>
...
<script type="text/javascript" src="{{URL::asset('js/moviesAdmin.js')}}"></script>
